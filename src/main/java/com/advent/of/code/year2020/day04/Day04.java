...
class Passport {
  ...
  private static Pattern hairColorPattern = Pattern.compile("^#[\\da-f]{6}$");
  private static Pattern passportIdPattern = Pattern.compile("^[\\d]{9}$");

  public boolean isValidPart2() {
    boolean birthYearIsValid = birthYear != null && 1920 <= birthYear && birthYear <= 2002;
    boolean issueYearIsValid = issueYear != null && 2010 <= issueYear && issueYear <= 2020;
    boolean expirationYearIsValid =
        expirationYear != null && 2020 <= expirationYear && expirationYear <= 2030;
    boolean heightIsValid = height != null && height.isValid();
    boolean hairColorIsValid = hairColor != null && hairColorPattern.matcher(hairColor).matches();
    boolean eyeColorIsValid =
        eyeColor != null
            && switch (eyeColor) {
              case "amb", "blu", "brn", "gry", "grn", "hzl", "oth" -> true;
              default -> false;
            };
    boolean passportIdIsValid =
        passportId != null && passportIdPattern.matcher(passportId).matches();
